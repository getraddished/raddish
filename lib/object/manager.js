 ...
 * @params {Boolean} initialize This is a force to reinitialize the object.
 * @returns {Promise} call ".then" to use the object when ready.
 */
ObjectManager.prototype.getObject = function (identifier, config, initialize) {
    ...
    return ObjectLoader.load(identifier, config, initialize);
};
