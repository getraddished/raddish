...
var config = null,
    ...
    ObjectLoader = require('raddish-loader'),
    initialized = false,
 ...
 */
Raddish.prototype.getConfig = function(identifier) {
    if(config === null) {
        return false;
    }
...
Raddish.prototype.init = function(callback) {
    initialized = true;
    ...
    ObjectLoader.Loader.addLocator(__dirname + '/../object/locator/core');
    ObjectLoader.Loader.addLocator(__dirname + '/../object/locator/component');
    ObjectLoader.Loader.setSequence(sequence);

    if(callback) {
        callback(ObjectLoader.Loader);
    }
...
Raddish.prototype.registerApplication = function(path) {
    if(!initialized) {
        throw new Error('Raddish isn\'t initialized yet!');
    }
