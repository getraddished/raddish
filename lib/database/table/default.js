...
Table.prototype.select = function (query, mode) {
    ...
    return this.getCommandChain()
        .run('initialize.select', context)
        .then(function (context) {
            return [self.getAdapter(), self.getCommandChain().run('before.select', context)];
        })
        ...
        .then(function(data) {
            ...
            return self.getCommandChain().run('after.select', context);
        })
        .then(function (context) {
            if (mode === 1) {
...
Table.prototype.insert = function (row) {
    ...
    return this.getQuery()
        ...
        .spread(function (adapter, context) {
            return [self.getAdapter(), self.getCommandChain().run('initialize.select', context)];
        })
        .spread(function(adapter, context) {
            return [adapter, self.getCommandChain().run('before.insert', context)];
        })
        .spread(function(adapter, context) {
        ...
        .spread(function(result, context) {
            ...
            return self.getCommandChain().run('after.insert', context);
        })
        .then(function(context) {
            return context.data;
        });
...
Table.prototype.update = function (row) {
    ...
    return this.getQuery()
        ...
        .spread(function(adapter, context) {
            return [adapter, self.getCommandChain().run('before.update', context)];
        })
        .spread(function(adapter, context) {
            return [adapter.execute(context.query), context];
        })
        .spread(function(result, context) {
            return self.getCommandChain().run('after.update', context);
        })
        .then(function(context) {
            return context.data;
        });
...
Table.prototype.delete = function (row) {
    ...
    return this.getQuery()
        ...
        .spread(function(adapter, context) {
            return [adapter, self.getCommandChain().run('before.delete', context)];
        })
        .spread(function(adapter, context) {
            return [adapter.execute(context.query), context];
        })
        .spread(function(result, context) {
            return self.getCommandChain().run('after.delete', context);
        })
        .then(function(context) {
            return context.data;
        });
