...
function Table(config) {
    ...
    this._column_map        = {};
    this._stream            = Raddish.getConfig('stream');
...
// We will do everything in the method, streaming and none-streaming.
...
Table.prototype.insert = function (row) {
    ...
    return this.getQuery()
        .then(function(query) {
            ...
            return self.execute('insert', self._defaultContext());
        });
};
...
Table.prototype.update = function (row) {
    ...
    return this.getQuery()
        .then(function(query) {
            ...
            return self.execute('update', self._defaultContext());
        });
};
...
Table.prototype.delete = function (row) {
    ...
    return this.getQuery()
        .then(function(query) {
            ...
            return self.execute('delete', self._defaultContext());
        });
};
...
Table.prototype._defaultContext = function() {
    var context     = new CommandContext();
    context.data    = row;
    context.table   = this.getName();
