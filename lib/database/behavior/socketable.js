...
Socketable.prototype.onAfterInsert = function(context) {
    var identifier = context.getProperty('caller').getIdentifier().clone();
    ...
    Socket.io.to(string).emit('new', context.getProperty('row').getData());
...
Socketable.prototype.onAfterUpdate = function(context) {
    ...
    Socket.io.to(SingleString).emit('edit', context.getProperty('row').getData());
    Socket.io.to(PluralString).emit('edit', context.getProperty('row').getData());
...
Socketable.prototype.onAfterDelete = function(context) {
    ...
    Socket.io.to(SingleString).emit('delete', context.getProperty('row').getData());
    Socket.io.to(PluralString).emit('delete', context.getProperty('row').getData());
