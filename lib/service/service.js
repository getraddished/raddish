...
Service.prototype.getComponentConfig = function(key) {
    ...
    if(!configs[identifier] ) {
        ...
        var file = app.config.componentFolder + '/' + this.getIdentifier().getPackage() + '/config.json';
        var backup = app.config.configFolder ? app.config.configFolder + '/' + this.getIdentifier().getPackage() + '/config.json' : false;
