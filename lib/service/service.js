...
Service.prototype.getComponentConfig = function(key) {
    var identifier = this.getIdentifier().getApplication() + ':' + this.getIdentifier().getComponent();
    ...
    if(!configs[identifier] ) {
        ...
        var file = app.config.componentFolder + '/' + this.getIdentifier().getComponent() + '/config.json';
        var backup = app.config.configFolder ? app.config.configFolder + '/' + this.getIdentifier().getComponent() + '/config.json' : false;
