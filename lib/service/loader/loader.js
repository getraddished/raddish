...
/**
 * ServiceLoader object which handles all the loading of the requested objects.
 *
 * @class ServiceLoader
 * @since 28 March 2014
 * @constructor
...
function ServiceLoader() {
    ...
    this.addLocator('../locator/plugin');
}
 ...
 */
ServiceLoader.prototype.addLocator = function (path) {
 ...
 */
ServiceLoader.prototype.resolve = function (identifier, callback) {
    var self = this;
...
ServiceLoader.prototype.parseSequence = function(string, identifier) {
...
ServiceLoader.prototype.getSequence = function() {
    if(this.sequence) {
        ...
        if(Raddish.getConfig('loader.sequence')) {
            ...
            this.sequence = [
                ...
                '<Type>://default/<Package>.<Path>.<Name>',
                '<Type>://default/<Package>.<Path>.default',
 ...
 */
ServiceLoader.prototype.receive = function (identifier) {
