...
function Router(req, res) {
    ...
    fs.exists(process.cwd() + '/public' + req.url, function(exists) {
        if(exists) {
            ...
            self.getDispatcher(req, function(dispatcher) {
...
Router.prototype.getDispatcher = function(req, callback) {
    var base = new Base();

    base.getObject(req.url.query.app + ':' + req.url.query.component + '.dispatcher', null, callback);
};
