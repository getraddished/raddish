...
Router.prototype.getRoute = function(req, res) {
    ...
    // The new router will do some more magic.
    // Also we have to make it so that thinks will be parsed corectly later on.
    ...
    for (var index in routes) {
        ...
        if (req.url === '/') {
            ...
            // We also have to check all the parts.
            // If one of the items is incorrect, we have to skip this route.
            var isFalse = false;
